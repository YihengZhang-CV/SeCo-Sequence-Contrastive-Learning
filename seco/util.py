...
def load_checkpoint(args, model, model_ema, contrast, optimizer, scheduler, logger=print):
...
def save_checkpoint(args, epoch, model, model_ema, contrast, optimizer, scheduler, logger=print):
    logger('==> Saving...')
    state = {
        'opt': args,
